...
<button
	class="text-muted-light border-2 border-foreground-muted bg-muted px-3 py-1 font-mono text-sm transition-colors duration-200 disabled:pointer-events-none {variants[
		variant
	]}"
	{onclick}
	{disabled}
