...
export function getAllConversations(): Promise<Record<string, Message[]>> {
...
export function getConsoleConversation(): Promise<Message[]> {
...
export function getChatConversation(): Promise<Message[]> {
...
export function getPlayerConversations(): Promise<Record<string, Message[]>> {
	return request('/conversation/player');
}

export function getConversation(id: string): Promise<Message[]> {
